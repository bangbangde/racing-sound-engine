...
const EnginePreset& get_preset_v8_cross() {
    static const EnginePreset preset = [] {
        ...
        // V8 cross-plane: strong fundamental, sub-harmonics, deep sound
        const float harmonics[] = {
            0.50f, 0.35f, 0.25f, 0.20f,  // 1-4: strong fundamental
            0.12f, 0.10f, 0.08f, 0.06f,  // 5-8
        ...
        // Deep, boomy exhaust
        p.exhaust_resonance_freq = 150.0f;
        p.exhaust_resonance_Q    = 1.2f;
